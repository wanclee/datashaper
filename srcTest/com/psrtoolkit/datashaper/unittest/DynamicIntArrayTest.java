...
/**
 * Unit test of DynamicIntArrayTest implementation
 *
 * @author Wan
 *
 */
public class DynamicIntArrayTest {
    ...
    public void testIntialization() {
        ...
        DynamicIntArray arr2 = new DynamicIntArray(200);
        assertTrue(arr2.length() == 200);
        arr2.add(999);
        assertTrue(arr2.lastpos() == 1);
        assertTrue(arr2.get(0) == 999);
    }

    @Test
    public void testIntializationNegative() {
        try {
            DynamicIntArray arr = new DynamicIntArray(-300);
    ...
    @Test
    public void testGet() {
        DynamicIntArray arr = new DynamicIntArray(200);
    ...
    /*
     * @Test public void testInternalStateNegative() { DynamicIntArray arr = new
     * DynamicIntArray(200); for (int i = 0; i < arr.length() ; i++) { arr.add(i
     * + 399); } arr.setlastpos(300);
     *
