 ...
 */
/**
 * Utility for handling Long-related processing
 */
...
public class LongUtil {
    ...
    /**
     * Utilize Long.parseLong to return long value
     *
     * @param longStr string containing the digits
     ...
     */
    public static long parseLong(String longStr, long minValue, long maxValue, String... context) {
        long size = 0;
        try {
            ...
            if (size < minValue || size > maxValue) {
                ...
                message.append("Error: The value '").append(longStr).append("'");
                if (size < minValue) {
            ...
            StringBuilder message = new StringBuilder(StringUtil.BUFFER_SIZE_100);
            message.append("Error: invalid value '").append(longStr).append("' found in '").append(StringUtil.constructTrailingMsg(context));
